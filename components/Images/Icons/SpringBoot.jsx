export default function SpringBoot({ height = "40px", width = "40px" }) {
    return (
        <svg height={height} width={width} fill="#6AAD3D" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
